...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Mar 2026 pada 16.29
...
(1, 'admin', 'admin123', 'Super Admin Tatib', 'SuperAdmin', '2026-03-10 15:12:11');
...
(29, '11360', 1, 1, 400, 175, 225, 800, 'SP1', 'SP1', 'SP1', 'SP1', 'None');
...
(30, 1, '09. Sarana Prasarana', 'Makan dan饮 di dalam kelas', 50, '1,2'),
...
(1, 3, 5, 1, '2026-03-10', '22:21:00', 'Genap', 'Kelas', NULL, 'None', NULL),
(3, 29, 5, 1, '2026-03-10', '22:25:00', 'Genap', 'Piket', NULL, 'None', NULL),
(4, 29, 5, 1, '2026-03-10', '22:28:00', 'Genap', 'Kelas', NULL, 'None', NULL);
...
--
ALTER TABLE `tb_pelanggaran_detail`
  MODIFY `id_detail` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `tb_pelanggaran_sanksi`
  MODIFY `id_trans_sanksi` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
